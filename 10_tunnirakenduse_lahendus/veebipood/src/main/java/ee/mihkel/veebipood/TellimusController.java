...
public class TellimusController {
    ...
    // POST localhost:8080/lisa-tellimus?id=9&tellijaIndex=3&toodeIndex=
...
//        ToodeController toodeController = new ToodeController();
    ...
    // POST localhost:8080/lisa-tellimus2?id=9&tellijaIndex=3&toodeIndexid=2,2,3
    ...
    public List<Tellimus> lisaToode3(
